  ...
  return (
    <Animated.View style={[s.card, { transform: [{ scale }] }]}>
      <TouchableOpacity activeOpacity={1} onPressIn={onPressIn} onPressOut={onPressOut}>
        ...
        {!isEnrolled && (
          <TouchableOpacity
            style={[s.registerBtn, enrolling && s.registerBtnLoading]}
            onPress={onEnroll}
            disabled={enrolling}
            activeOpacity={0.8}
          >
...
const s = StyleSheet.create({
  ...
  codeChip:    { borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3, backgroundColor: ACCENT + '15' },
  codeChipText:{ fontSize: 11, fontWeight: '700', color: ACCENT },
